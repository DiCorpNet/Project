...
$("#search-user").on("keyup",function(a){a=$(this).val();var b=document.getElementById("user-search-list");""!=a&&3<a.length&&($(".search-to").fadeOut(),b.innerHTML="",axios.get("/message/search-user/"+a+"/").then((a)=>{a=a.data;if(0!=a.length){for(i=0;a.length>i;i++)b.innerHTML+='<li class="nav-item" value="'+a[i].room+'">       <div class="row">           <div class="col-2">               <img class="img-fluid rounded-circle" src="'+a[i].image+'" alt="">           </div>           <div class="col-10" value="'+
